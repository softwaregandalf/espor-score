...
const tr: Record<keyof typeof en, string> = {
  ...
  deleteCommentConfirmDesc: "Bu yorumu silmek istediğinize emin misiniz? Bu işlem geri alınamaz.",
  cancelBtn: "İptal",
  ...
  liveMatches: "Maçlar",
  swipeToCloseMatches: "Akış için sola kaydır",
  results: "Sonuçlar",
  ...
  esportsAgenda: "Espor Gündemi",
  esportsAgendaDesc: "En sıcak transferler, oyuncu tepkileri ve resmi duyurular.",
  feedComposePlaceholder: "Espor dünyasında neler oluyor?",
  transferLeak: "Transfer Sızıntısı",
  officialAnnouncement: "Resmi Duyuru",
  mediaLoading: "Medya Yükleniyor...",
  sponsoredContent: "Sponsorlu İçerik",
  hideLabel: "Gizle",
  feedAdTitle: "Oyunculara Özel Lansman İndirimi",
  feedAdDesc: "Tepki süreni sıfıra indir, reflekslerini zirveye taşı. NexusGear Pro serisi ekipmanlarda bu hafta sonuna özel %25 indirim seni bekliyor.",
  shopNow: "Hemen İncele",
  trending: "Trendler",
